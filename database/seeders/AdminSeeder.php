...
// Seeder encargado de crear el rol y el usuario administrador
class AdminSeeder extends Seeder
{
     ...
     */
    // Método que ejecuta el llenado de datos del administrador
    public function run(): void
    {
        ...
        // Inserta o actualiza el rol "Administrador"
        DB::table('rol')->updateOrInsert(
            ['id_rol' => 1], // Criterio de búsqueda: id_rol igual a 1
            ['rol' => 'Administrador'], // Valor asignado: nombre del rol
        );

        // Crea o actualiza el usuario administrador con sus datos asociados
        User::updateOrCreate(
            ['Documento' => 10000000001], // Criterio de búsqueda: documento identificador del admin
            [
                'Nom_usua' => 'Administrador SCAPE', // Nombre del usuario
                'email' => 'kevinestebanmunoz10@gmail.com', // Correo electrónico del usuario
                'Telefono' => '3000000000', // Número de teléfono del usuario
                'QR' => 'QR-ADMIN', // Código QR asignado
                'Contrasena' => 'admin123', // Contraseña del usuario (por defecto en texto plano)
