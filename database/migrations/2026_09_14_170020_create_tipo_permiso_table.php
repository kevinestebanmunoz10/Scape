...
return new class extends Migration
{
    ...
    {
        // Crea la tabla 'tipo_permiso'
        Schema::create('tipo_permiso', function (Blueprint $table) {
            $table->increments('id_tipo_permiso'); // Columna auto-incremental con el identificador del tipo de permiso
            $table->string('tipo', 50); // Columna de texto con el nombre del tipo de permiso (máx. 50)
        });
    }
    ...
    {
        Schema::dropIfExists('tipo_permiso'); // Elimina la tabla 'tipo_permiso'
    }
};
