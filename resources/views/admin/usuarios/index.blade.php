                        ...
                        <tr>
                            ...
                            <td class="cell-actions">
                                <div class="table-actions">
                                    ...
                                    {{-- Si el usuario está activo, ofrece desactivarlo; si no, activarlo --}}
                                    @if ((int) $usuario->estado?->estado === 1)
                                        {{-- Formulario que desactiva el usuario (envío DELETE) con confirmación previa --}}
                                    ...
                                    @else
                                        {{-- Formulario que reactiva un usuario inactivo --}}
